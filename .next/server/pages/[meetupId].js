...
async function getStaticPaths() {
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://8869:Umanand321@cluster0.xrrz76s.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
    ...
    return {
        props: {
            meetupData: {
                ...
                title: selectedMeetup.title ? selectedMeetup.title : "",
                address: selectedMeetup.address ? selectedMeetup.address : "",
                image: selectedMeetup.image ? selectedMeetup.image : "",
                description: selectedMeetup.description ? selectedMeetup.description : ""
            }
        }
    };
}
